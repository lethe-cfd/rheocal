...
def Runregression(param0,law,dgammaE,etaE):
...
btn_run=Button(root, text="Run",bg="orange")
btn_run.bind("<Button-1>", lambda event: Runregression(param,select_mod.get(),dgammaE,etaE))
btn_run.grid(row=1, column=0,padx=20,sticky="e")
